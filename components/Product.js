...
export default function Product({ _id, name, price, description, picture }) {
    ...
    return (
        <div className='w-56'>
            ...
            <p className='text-sm mt-1 leading-4'>{description.slice(0, 50)}
                <Link href={`/details/${_id}`} className='text-emerald-500' > See more...</Link>

            </p>
            <div className='flex mt-1'>
                <div className='flex text-2xl font-bold grow'> <Image width='24' height='24' src='/naira.png' alt='naira' />{price}</div>
